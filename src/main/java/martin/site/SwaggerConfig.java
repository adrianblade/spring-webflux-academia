...
public class SwaggerConfig {
	public static final Contact DEFAULT_CONTACT = new Contact("Martin Carrillo", "https://www.facebook.com/martin.carrillodurand",
			"martincarrillodurand@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Academia Rest WebFlux Api Documentation", "WebFlux Api Documentation", "1.0",
